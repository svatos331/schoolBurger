...
@charset "UTF-8";
	...
	.react-datepicker-popper[data-placement^=bottom] .react-datepicker__triangle::before, .react-datepicker-popper[data-placement^=bottom] .react-datepicker__triangle::after {
		border-top: none;
		border-bottom-color: ${Colors.WHITE_DEFAULT};
	}
	...
	.react-datepicker__year-text--keyboard-selected {
		border-radius: 0.3rem;
		background-color: ${Colors.ORANGE_HOVER};
		color: ${LocaleColors.BLACK_ALPHA};
	}
...
.react-datepicker__quarter-text--in-range,
.react-datepicker__year-text--in-range) {
		background-color: ${LocaleColors.ORANGE_ALPHA};
	}
...
.react-datepicker__year-text--in-selecting-range) {
	...
	.react-datepicker__month-year-read-view:hover .react-datepicker__month-read-view--down-arrow {
		border-top-color: ${Colors.BUTTON_DISABLED_BG};
	}
	.react-datepicker__year-read-view--down-arrow,
	.react-datepicker__month-read-view--down-arrow,
	...
	.react-datepicker__month-year-option:hover .react-datepicker__navigation--years-upcoming {
		border-bottom-color: ${Colors.BUTTON_DISABLED_BG};
	}
