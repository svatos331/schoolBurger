		...
		case Tags.h1:
			return (
				<ST.H1
					...
					large_mq={large_mq}
					large_extra_mq={large_extra_mq ? large_extra_mq : "50px"}
		...
		case Tags.h2:
			return (
				<ST.H2
					...
					large_mq={large_mq}
					large_extra_mq={large_extra_mq ? large_extra_mq : "40px"}
					font_style={font_style ? font_style : "normal"}
				>
					{children}
				</ST.H2>
		...
		case Tags.h3:
			return (
				<ST.H3
					...
					large_mq={large_mq}
					large_extra_mq={large_extra_mq ? large_extra_mq : "24px"}
					font_style={font_style ? font_style : "normal"}
				>
					{children}
				</ST.H3>
		...
		case Tags.p2:
			return (
				<ST.P
					...
					large_mq={large_mq}
					large_extra_mq={large_extra_mq ? large_extra_mq : "12px"}
					font_style={font_style ? font_style : "normal"}
				>
					{children}
				</ST.P>
